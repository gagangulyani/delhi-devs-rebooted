...
export const mockEvents = [
  {
    ...
    event_link: null, // In-person event, no virtual link
    location_url: 'https://maps.google.com/?q=Connaught+Place+New+Delhi',
    max_attendees: 50,
    current_attendees: 32,
    show_attendees: true,
    prerequisites: 'Basic knowledge of JavaScript and HTML/CSS. Laptop required.',
    instructions: 'Please arrive 15 minutes early for registration. Parking is available at the venue. Bring your laptop with Node.js installed.',
    agenda: '- 10:00 AM: Registration & Networking\n- 10:30 AM: Introduction to Modern React\n- 12:00 PM: Hands-on Session\n- 1:00 PM: Lunch Break\n- 2:00 PM: Advanced Hooks & Patterns\n- 4:00 PM: Q&A Session',
    host_contact: 'rahul.sharma@email.com',
    attendees: [
      { id: 'user-1', display_name: 'Rahul Sharma', avatar_url: null },
      { id: 'user-2', display_name: 'Priya Patel', avatar_url: null },
      { id: 'user-3', display_name: 'Arjun Gupta', avatar_url: null },
      { id: 'user-4', display_name: 'Sneha Jain', avatar_url: null },
      { id: 'member-1', display_name: 'Amit Kumar', avatar_url: null },
      { id: 'member-2', display_name: 'Pooja Desai', avatar_url: null },
      { id: 'member-3', display_name: 'Siddharth Joshi', avatar_url: null },
      { id: 'member-4', display_name: 'Riya Malhotra', avatar_url: null },
      { id: 'member-5', display_name: 'Aditya Saxena', avatar_url: null },
      { id: 'member-6', display_name: 'Karan Mehta', avatar_url: null },
      { id: 'member-7', display_name: 'Divya Kapoor', avatar_url: null },
      { id: 'member-8', display_name: 'Rohan Verma', avatar_url: null },
      { id: 'member-9', display_name: 'Neha Agarwal', avatar_url: null },
      { id: 'member-10', display_name: 'Vikram Singh', avatar_url: null },
      { id: 'member-11', display_name: 'Ananya Reddy', avatar_url: null },
    ],
  ...
  },
  {
    ...
    instructions: 'Zoom link will be shared 30 minutes before the event. Please test your audio/video before joining.',
    agenda: '- 6:30 PM: Introductions\n- 7:00 PM: Keynote on LLMs\n- 8:00 PM: Project Showcases\n- 8:30 PM: Networking Session',
    host_contact: 'priya.patel@email.com',
    attendees: [
      { id: 'user-2', display_name: 'Priya Patel', avatar_url: null },
      { id: 'user-1', display_name: 'Rahul Sharma', avatar_url: null },
      { id: 'user-5', display_name: 'Vikram Singh', avatar_url: null },
      { id: 'member-13', display_name: 'Siddharth Joshi', avatar_url: null },
    ],
  ...
  },
  {
    ...
    show_attendees: false, // Hidden attendees for this event
    attendees: [],
  ...
  },
  {
    ...
    location_url: 'https://maps.google.com/?q=Noida+Sector+62',
    max_attendees: 40,
    current_attendees: 25,
    show_attendees: true,
    prerequisites: 'Laptop with Docker installed. AWS/Azure account (free tier acceptable).',
    instructions: 'In-person attendees: Venue address will be shared via email. Virtual attendees: Teams link will be shared 1 hour before the event.',
    agenda: '- 5:00 PM: Registration\n- 5:30 PM: DevOps Fundamentals\n- 6:30 PM: CI/CD Demo\n- 7:30 PM: Cloud Deployment Workshop\n- 8:30 PM: Q&A',
    host_contact: 'sneha.jain@email.com',
    attendees: [
      { id: 'user-4', display_name: 'Sneha Jain', avatar_url: null },
      { id: 'user-3', display_name: 'Arjun Gupta', avatar_url: null },
      { id: 'member-15', display_name: 'Aditya Saxena', avatar_url: null },
    ],
  ...
  },
  {
    ...
    attendees: [
      { id: 'user-5', display_name: 'Vikram Singh', avatar_url: null },
      { id: 'member-10', display_name: 'Neha Agarwal', avatar_url: null },
      { id: 'member-11', display_name: 'Amit Kumar', avatar_url: null },
    ],
    max_attendees: 75,
