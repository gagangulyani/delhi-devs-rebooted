...
/**
 * Format date for display - full format with weekday
 * @param dateString - ISO date string
 * @returns Formatted date like "Monday, October 1, 2025"
 */
 ...
 * @deprecated Use individual exported functions instead for better tree-shaking
 */
