...
export const metadata: Metadata = {
  title: {
    default:
      "Delhi Devs Rebooted - Connecting Passionate Developers in Delhi NCR",
    template: "%s | Delhi Devs Rebooted",
  },
  description:
    "Join Delhi Devs Rebooted - the largest developer community in Delhi NCR. Connect with passionate developers, attend tech meetups, share knowledge, and build the future of technology together. Founded by Gagan Deep Singh.",
  keywords: [
    "delhi developers",
  ...
  openGraph: {
    title:
      "Delhi Devs Rebooted - Connecting Passionate Developers in Delhi NCR",
    description:
      "Join the largest developer community in Delhi NCR. Connect, collaborate, and code with passionate developers. Attend tech meetups, share knowledge, and build the future together.",
  ...
  twitter: {
    ...
    title:
      "Delhi Devs Rebooted - Connecting Passionate Developers in Delhi NCR",
    description:
      "Join the largest developer community in Delhi NCR. Connect, collaborate, and code with passionate developers.",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description:
      "The largest developer community in Delhi NCR connecting passionate developers, hosting tech meetups, and building the future of technology together.",
    url: "https://delhidevs.com",
    ...
    sameAs: ["https://www.linkedin.com/company/delhi-devs"],
    memberOf: {
      "@type": "Organization",
