...
import { Users, MapPin, Github } from "lucide-react";
    ...
    <section className="min-h-screen flex items-center pt-8 md:pt-16 pb-20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-center">
          ...
          <div className="relative h-80 sm:h-96 lg:h-[560px] flex items-center justify-center reveal lg:order-2 mb-8 lg:mb-0">
            <img
          ...
          <div className="text-center lg:text-left hero-content lg:order-1 space-y-6">
            <div className="flex items-center gap-2 mb-6 hero-badge reveal justify-center lg:justify-start">
              <Badge className="bg-primary text-primary-foreground border-0 rounded-full px-4 py-2">
                <MapPin className="w-4 h-4 mr-2" />
                Delhi NCR Tech Hub
              </Badge>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight reveal">
              Connect.
            ...
            <div className="flex flex-col sm:flex-row gap-4 hero-buttons reveal items-center justify-center lg:justify-start pt-4">
